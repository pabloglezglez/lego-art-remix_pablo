...
function addWaterMark(pdf, isHighQuality) {
    for (let i = 0; i < pdf.internal.getNumberOfPages(); i++) {
        ...
        pdf.text(
            ...
            "Generated by Pablo/only to test"
        );
        pdf.text(pdf.internal.pageSize.height * 0.95, pdf.internal.pageSize.height * 0.5 + 10, VERSION_NUMBER);
    }
}
      ...
      //  });
       ...
       // const totalPlates = resultImage.length / (4 * PLATE_WIDTH * PLATE_WIDTH);
        ...
        for (var i = 0; i < totalPlates; i++) {
            ...
            instructionPageCanvas.width = 1000;  // ancho total: mosaico + espacio para texto/PABLO
